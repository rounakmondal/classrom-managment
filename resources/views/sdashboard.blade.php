  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      <div class="row justify-content-center">
        <h4 class="text-center">your class</h4>
      </div>
...
@php
$studentclass=DB::table('studentclasses')->where('email',session('email'))->get();
$student_class_exist=DB::table('studentclasses')->where('email',session('email'))->exists();

@endphp
@if($student_class_exist)
...
<h1>you are not added any classes</h1>
@endif
